    ...
    return (
        <div className="flex flex-col md:flex-row md:w-full mt-2">
            <div className="flex items-center justify-between p-4 bg-blue-grayish-light rounded-md my-2 md:w-1/2 md:mr-4 md:my-0">
                <img src={iconMinus} alt="minus icon" className="hover:opacity-60 hover:cursor-pointer" onClick={() => updateCount(-1)}/>
                <span className="text-blue-dark font-bold">{count}</span>
                <img src={iconPlus} alt="plus icon" className="hover:opacity-60 hover:cursor-pointer" onClick={() => updateCount(1)}/>
            </div>

            <button className="flex items-center justify-center bg-orange p-4 rounded-md mt-2 w-full md:mt-0 hover:opacity-75 hover:cursor-pointer shadow-[#ff7d1a94] shadow-lg" onClick={handleClick}>
